...
#include "..\std.h"
#include ".\Sim.h"
#include "..\CoupModelutil\FUtil.hpp"
#include <ctime>
#include <thread>
#include <direct.h>
...
//		PARAMETERS_mp_WORKDIR[i]=UserDirectory[i];
	...
	FUtil::WriteProfileInt("SimulationRunNo", m_DocFile.m_SimulationRunNo+MR_Get_TotalNumberofRuns());
