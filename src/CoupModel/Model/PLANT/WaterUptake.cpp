...
bool WaterUptake::Def()
{
	...
	funcname = "Water Uptake Original TempFunction - multiplant";
	plotpar.Num_Of_Curves = 2;
	plotpar.X_Max = 20;
	plotpar.LogXScale = false;
	plotpar.X2_Vec = { 1.f,200.f };
	...
	funcname = "Water Uptake Trig TempFunction - multiplant";
	...
	funcname = "Water Uptake Polynomial Trig TempFunction - multiplant";
